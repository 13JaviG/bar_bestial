...
public class Loro extends Animal {
	...
	{	
		if (pCarta.getColor() == Juego.jugadorColor) {
			int pIndex = 0;
				String textoDialogo = JOptionPane.showInputDialog("Qu� posici�n ocupa la carta que deseas eliminar? Introduce un valor entre 0 y "+(ColaDelBar.getColaDelBar().cuantasHay()-1));
